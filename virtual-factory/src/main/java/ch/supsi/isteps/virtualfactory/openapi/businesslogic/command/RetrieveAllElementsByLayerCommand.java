...
public class RetrieveAllElementsByLayerCommand extends AbstractCommand {

	private AbstractPersistence _repository;

	public RetrieveAllElementsByLayerCommand(AbstractPersistence repository) {
		_repository = repository;
	}

	@Override
	public void execute(Fields anInput, Fields anOutput) {
		Fields result = _repository.retrieveAllElementsByLayer(anInput.select(RealToDigitalSyncData.LAYER_NAME));
