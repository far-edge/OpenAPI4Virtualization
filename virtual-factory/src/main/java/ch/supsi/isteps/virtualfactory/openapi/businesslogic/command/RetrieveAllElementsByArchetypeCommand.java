...
public class RetrieveAllElementsByArchetypeCommand extends AbstractCommand {

	private AbstractPersistence _repository;

	public RetrieveAllElementsByArchetypeCommand(AbstractPersistence repository) {
		_repository = repository;
	}

	@Override
	public void execute(Fields anInput, Fields anOutput) {
		Fields result = _repository.retrieveAllElementsByArchetype(anInput.select(RealToDigitalSyncData.ARCHETYPE));
