...
public class RemoveAttributesByElementNameCommand extends AbstractCommand {

	private AbstractPersistence _repository;

	public RemoveAttributesByElementNameCommand(AbstractPersistence repository) {
		_repository = repository;
	}

	@Override
	public void execute(Fields anInput, Fields anOutput) {
		Fields result = _repository.removeAllAttributesByElement(anInput.select(RealToDigitalSyncData.ELEMENT_NAME));
