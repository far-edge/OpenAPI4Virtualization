...
public class RemoveLinkBySourceElementCommand extends AbstractCommand {

	private AbstractPersistence _repository;

	public RemoveLinkBySourceElementCommand(AbstractPersistence repository) {
		_repository = repository;
	}

	@Override
	public void execute(Fields anInput, Fields anOutput) {
		Fields result = _repository.removeLinkBySourceElement(anInput.select(RealToDigitalSyncData.FROM_ELEMENT));
